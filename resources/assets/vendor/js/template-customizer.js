...
TemplateCustomizer.LANGUAGES = {
  ...
  es: {
    panel_header: "PERSONALIZADO DE PLANTILLA",
    ...
    layout_label: "Diseño (Menú)",
    layout_static: "Estático",
    layout_offcanvas: "Offcanvas",
    layout_fixed: "Fijo",
    layout_fixed_offcanvas: "Fijo con offcanvas",
    layout_flipped_label: "Menú invertido",
    layout_dd_open_label: "Desplegable al pasar el cursor",
    layout_navbar_label: "Barra de navegación fija",
    layout_footer_label: "Pie de página fijo",
    misc_header: "VARIOS",
    rtl_label: "Dirección RTL"
  }
}
