  ...
  <div class="authentication-inner row">
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4 mx-auto">
      <div class="w-px-400 mx-auto">
        ...
        <p class="mb-4">Enter your email and we'll send you instructions</p>
        ...
        <form id="formAuthentication" class="mb-3" action="{{ route('password.email') }}" method="POST">
          ...
          <button type="submit" class="btn btn-info d-grid w-100">Send Reset Link</button>
        </form>
        <div class="text-center">
          @if (Route::has('login'))
          <a href="{{ route('login') }}" style="color: #00bad1" class="d-flex align-items-center justify-content-center">
